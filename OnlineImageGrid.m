function GridCovArray = OnlineImageGrid(I,GridNum)
%--------------------------------------------------
%Divide the normalized template into blocks and extract covariance matrix
%as feature to represent each block. This function is used on the fly. 
...
for i = 1:GridNum(1)
    ...
    for j = 1:GridNum(2)
        ...
        GridCovArray{i,j} = Matrix2Vector(logm(eye(6)*1e-5+GPC(I(Idx,Idy),[1 1],...
